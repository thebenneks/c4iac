...
function generateModule(grammars, config, grammarConfigMap) {
    ...
    const hasIParserConfigImport = !!parserConfig || grammars.some(grammar => { var _a; return ((_a = grammarConfigMap.get(grammar)) === null || _a === void 0 ? void 0 : _a.chevrotainParserConfig) !== undefined; });
