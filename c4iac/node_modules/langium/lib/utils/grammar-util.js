...
function findNameAssignmentInternal(type, cache) {
    ...
    for (const node of (0, ast_util_1.streamAllContents)(type)) {
        ...
        else if (ast.isAtomType(node) && ((_a = node === null || node === void 0 ? void 0 : node.refType) === null || _a === void 0 ? void 0 : _a.ref)) {
...
function loadGrammarFromJson(json) {
    ...
    return (0, internal_grammar_util_1.prepareGrammar)(services, astNode);
}
 ...
 */
function createServicesForGrammar(config) {
    ...
    const grammarNode = typeof config.grammar === 'string' ? grammarServices.parser.LangiumParser.parse(config.grammar).value : config.grammar;
    (0, internal_grammar_util_1.prepareGrammar)(grammarServices, grammarNode);
