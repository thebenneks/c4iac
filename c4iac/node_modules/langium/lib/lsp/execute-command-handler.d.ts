...
export declare type ExecuteCommandFunction = (args: any[], cancelToken: CancellationToken) => MaybePromise<unknown>;
export declare type ExecuteCommandAcceptor = (name: string, execute: ExecuteCommandFunction) => void;
