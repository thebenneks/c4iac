...
class DefaultLanguageServer {
    ...
    buildInitializeResult(_params) {
        ...
        const formattingOnTypeOptions = languages.map(e => { var _a; return (_a = e.lsp.Formatter) === null || _a === void 0 ? void 0 : _a.formatOnTypeOptions; }).find(e => !!e);
