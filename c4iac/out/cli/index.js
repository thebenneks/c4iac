...
const c_4_iac_module_1 = require("../language-server/c-4-iac-module");
const cli_util_1 = require("./cli-util");
const generator_1 = require("./generator");
const node_1 = require("langium/node");
const generateAction = (fileName, opts) => __awaiter(void 0, void 0, void 0, function* () {
    const services = (0, c_4_iac_module_1.createC4IacServices)(node_1.NodeFileSystem).C4Iac;
...
function default_1() {
    ...
    const fileExtensions = module_1.C4IacLanguageMetaData.fileExtensions.join(', ');
    program
        .command('generate')
